...
function SettingsButton() {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'flex-end', marginLeft: '10px' }}> {/* Adjust marginLeft as needed */}
      <button className="with-text" onClick={handleClick} style={{ display: 'flex', alignItems: 'center' }}>
        ...
        <span style={{ marginLeft: '5px' }}>Settings</span> {/* Adjust marginLeft as needed */}
      </button>
    </div>
  );
}
