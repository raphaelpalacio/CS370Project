...
function SettingsButton() {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'flex-end', paddingRight: '55px' }}>
      <button className="with-text" onClick={() => setShowSettings(prev => !prev)} ref={buttonRef} style={{ padding: '8px 12px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '4px' }}>
        ...
        <span style={{ fontSize: `${fontSize}px`, lineHeight: '1.2', verticalAlign: 'middle' }}>Set Time</span>
      </button>
    </div>
  );
}
